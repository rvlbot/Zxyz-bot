...
conn.sendMessage(id, ' *Owner Zxyz Bot wa.me/+6285762102148* ' ,MessageType.text);
}
else if (text == '#help'){
...
conn.sendMessage(id, ' *Creator Zxyz Bot wa.me/+6285762102148* ' ,MessageType.text);
}
else if (text == 'Pagi'){
  ...
  var teks = text.replace(/!nulis /, '')
    ...
    .then((res) => {
      imageToBase64(res.data.result)
        .then(
          (ress) => {
            conn.sendMessage(id, '[WAIT] Bot Lagi Nulis Ni❗', MessageType.text)
  ...
  var teks = text.replace(/!tts /, '')
    ...
    .then((res) => {
      audioToBase64(res.data.result)
        .then(
          (ress) => {
            conn.sendMessage(id, '[WAIT] Sedang bot proses❗', MessageType.text)
            var buf = Buffer.from(ress, 'base64')
...
if (text.includes("!infoig")){
  ...
  conn.sendMessage(id, '[WAIT] Lagi Mencari Ni !⏳', MessageType.text)
